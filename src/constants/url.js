const URL = {
  ...
  //ABOUT
  ABOUT: "/about", //사이트소개
  ABOUT_SITE: "/about/intro", // 사이트소개/소개
  ...
  BOOK_DELETE_URL: "/admin/book/delete/:bookId", // 도서 삭제페이지
  BOOK_DELETE: (bookId) => `/admin/book/delete/${bookId}`, // 도서 삭제페이지 함수

  BOOK_DELETED: "/admin/book/deleted", // 관리자 삭제도서목록
