function MypageBorrowStatus({ borrows, loading, getStatusConfig, handlers }) {
        ...
        <div className="mypage-content-container">
            ...
            <div className="list-container">
                {borrows.length > 0 ? (
                    ...
                    <div className="empty-row" style={{ textAlign: 'center', padding: '40px 0' }}>
...
export default MypageBorrowStatus