const BookSearchBar = ({ placeholder, handler, run = true }) => {
    return (
        <div className="filter-section">
            {run ? (
                <>
                    <input type="text" name="bookTitle" placeholder={placeholder} onChange={(e) => handler.handleChangeSearchParams(e.target)} />
                ...
                <>
                    <input type="text" name="bookTitle" placeholder={placeholder} />
