        ...
        <div className='agreement-container'>
            ...
            <AgreementTerm
                ...
                contents={`[개인정보 처리방침]
                    ...
                    3. 개인정보의 보유 및 이용기간
                    - 이용자의 개인정보는 원칙적으로 회원 탈퇴 시 즉시 비활성화 처리되어 서비스 이용이 차단됩니다.
                    - 다만, 회원의 악의적인 연체 후 탈퇴, 도서 미반납 및 고의적인 재가입을 통한 부정 이용을 방지하고, 도서관의 자산 보호 및 대출 통계의 무결성을 유지하기 위해 탈퇴 회원의 개인정보는 탈퇴 후 아래 보존 기간 동안 별도의 데이터베이스로 분리 또는 비활성화 상태로 안전하게 보존된 후 파기됩니다.
                     * 보존 기간: 본 도서관 서비스의 운영 종료 시까지 보존 후 일괄 파기
                    
                    - 미반납 도서가 있거나 연체 페널티 의무가 완료되지 않은 회원은 해당 의무가 해소될 때까지 탈퇴 신청이 보류되거나, 의무 해소 시점까지 개인정보가 파기되지 않고 관리 목적으로 지속 보존됩니다.
